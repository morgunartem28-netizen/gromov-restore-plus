...
class IpatoolClient:
    ...
    _TWO_FACTOR_HINT = (
        ...
        "При неверном пароле push не приходит — сначала проверьте email/пароль.\n"
        "Код: уведомление на доверенном устройстве или Настройки → Apple ID → "
        "Получить код проверки. Введите 6 цифр сразу и снова «Войти»."
    )
